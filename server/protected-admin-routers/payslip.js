...
function getTotal(reqBody, objectName, savedObject) {
    ...
    const saveObjectKeyPairs = Object.entries(savedObject._doc);
...
// EDITTING PAYSLIP TEMPLATE FOR EMPLOYEES BREAKDOWN
router.put('/payslip/earnings/:id', async (req, res, next)=> {
    ...
    try {
        ...
        const sum = getTotal(req.body, 'Earnings', earningObject['Earnings']);
